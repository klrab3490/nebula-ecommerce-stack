...
export default function Footer() {
    ...
    return (
        <footer className="relative overflow-hidden mt-20">
            ...
            <div
                className="absolute bottom-0 right-1/4 w-72 h-72 bg-pink-500/10 rounded-full blur-3xl animate-pulse"
                ...
                <div className="py-16">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-purple-100/80 text-sm leading-relaxed">
                                Premium beauty & wellness platform delivering natural, high-quality
                        ...
                        <div className="space-y-6">
                            ...
                            <form className="flex gap-2">
                                ...
                                <Button
                                    size="sm"
                                    type="submit"
                                    className="bg-linear-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white border-0 rounded-xl px-6 py-3 font-bold shadow-lg hover:shadow-xl transition-all duration-300"
                                >
                                    Subscribe
                                </Button>
                            </form>
                    ...
                    <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
                        <p className="text-sm text-purple-200/80 w-full text-center md:text-left">
                            © 2025{" "}
                            <span className="font-bold bg-linear-to-r from-purple-200 to-pink-200 bg-clip-text text-transparent">
