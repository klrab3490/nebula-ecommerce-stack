      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-12 relative z-10">
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center max-w-2xl mx-auto">
            ...
            <Button 
              asChild 
              className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white border-0 rounded-xl px-8 py-4 font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300"
            >
