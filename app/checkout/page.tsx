        ...
        <div className="mt-4 p-4 border rounded-lg bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-200">
          ...
          {addresses.length > 0 ? (
            <div className="space-y-3">
              ...
              <div className="mt-4">
                <Button className="btn mr-2" onClick={() => router.push("/account/address/add")}>
                  Add Address
                </Button>
                <Button className="btn" onClick={() => router.push("/account/address")}>
                  Manage Addresses
                </Button>
              </div>
            </div>
            ...
            <div>
              ...
              <Button className="btn mt-2" onClick={() => router.push("/add-address")}>
                Add Address
              </Button>
            </div>
          )}
