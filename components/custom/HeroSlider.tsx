...
export default function HeroSlider() {
    ...
    return (
        <div className="relative w-full h-fit overflow-hidden rounded-b-3xl shadow-2xl">
            ...
            <button
                onClick={prevSlide}
                className="absolute left-6 top-1/2 -translate-y-1/2 bg-white/10 hover:bg-white/20 backdrop-blur-xl text-white p-4 rounded-full transition-all duration-300 hover:scale-110 border border-white/20 shadow-xl z-20 group"
            ...
            <button
                onClick={nextSlide}
                className="absolute right-6 top-1/2 -translate-y-1/2 bg-white/10 hover:bg-white/20 backdrop-blur-xl text-white p-4 rounded-full transition-all duration-300 hover:scale-110 border border-white/20 shadow-xl z-20 group"
