                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 ml-11">
                      Featured products are highlighted on the homepage and
                      require a discounted price
                    </p>
                  </div>
            ...
            <CardHeader className="pb-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-rose-100 dark:bg-rose-900/50 rounded-full flex items-center justify-center">
                  <span className="text-rose-600 dark:text-rose-400 text-xl">
                    ❓
                  </span>
                </div>
                <div>
                  ...
                  <CardDescription className="text-sm">
                    Frequently asked questions to help customers learn more
                    about your product
                  </CardDescription>
                </div>
              </div>
            ...
            <CardContent className="space-y-6">
              ...
              {formData.faqs.length > 0 ? (
                ...
                <div className="text-center py-8 border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-xl bg-slate-50 dark:bg-slate-800/50">
                  ...
                  <p className="text-xs text-slate-500">
                    You can add frequently asked questions to provide more
                    product details
                  </p>
                </div>
              )}
