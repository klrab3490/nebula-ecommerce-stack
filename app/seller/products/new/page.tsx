      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Create a compelling product listing that showcases your items and attracts customers to
            your store
          </p>
        </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 ml-11">
                      Featured products are highlighted on the homepage and require a discounted
                      price
                    </p>
                  </div>
                  <div className="shrink-0 ml-6">
                    <button
                      ...
                      className={`relative inline-flex h-8 w-14 items-center rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 ${
                        formData.featured ? "bg-primary" : "bg-slate-200 dark:bg-slate-700"
                      }`}
                    >
                      <span
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3">
                  <Input
                    ...
                    onKeyPress={(e) =>
                      e.key === "Enter" &&
                      (e.preventDefault(), addCategory(newCategory), setNewCategory(""))
                    }
            ...
            <CardContent className="space-y-6">
              ...
              {formData.faqs.length > 0 ? (
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {formData.faqs.map((faq, index) => (
                      <div
                        key={index}
                        className="group p-4 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700"
                      >
                ...
                <div className="text-center py-8 border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-xl bg-slate-50 dark:bg-slate-800/50">
                  ...
                  <p className="text-xs text-slate-500">
                    You can add frequently asked questions to provide more product details
                  </p>
                </div>
              )}
            </CardContent>
